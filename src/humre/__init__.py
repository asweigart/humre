...
ASTERISK = r'\*'
PLUS_SIGN = r'\+'
MINUS_SIGN = r'\-'  # NOTE - Not strictly needed, but here since PLUS_SIGN is.
QUESTION_MARK = r'\?'
OPEN_BRACE = r'\{'
CLOSE_BRACE = r'\}'
OPEN_BRACKET = r'\['
...
def positive_lookahead(*tuple_of_regex_strs):  # type: (str) -> str
...
def positive_lookbehind(*tuple_of_regex_strs):  # type: (str) -> str
